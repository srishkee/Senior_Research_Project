...
print("\nCHANGE: Running " + NAME+ " with 1 attention module! encoder_depth = 1\n")
...
def load_plantvillage(seed=None, root_dir=None):
  ...
  # Calculate class weight: TODO: how + why
...
def get_resnet18(input_shape=(224,224,3), num_classes=38):
    ...
    print("Added 1st conv_block!")
    x = attention_block(x, encoder_depth=1)
    # x = identity_block(x, 3, [64, 64, 256], stage=2, block='b')
    # x = identity_block(x, 3, [64, 64, 256], stage=2, block='c')
    print("Added 1st attention_block!")

    x = conv_block(x, 3, [128, 128, 512], stage=3, block='a')
    print("Added 2nd conv_block!")
    # x = attention_block(x, encoder_depth=1)
    x = identity_block(x, 3, [128, 128, 512], stage=3, block='b')
    # x = identity_block(x, 3, [128, 128, 512], stage=3, block='c')
    # x = identity_block(x, 3, [128, 128, 512], stage=3, block='d')
    print("Added 2nd identity_block!")

    x = conv_block(x, 3, [256, 256, 1024], stage=4, block='a')
    print("Added 3rd conv_block!")
    # x = attention_block(x, encoder_depth=1)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='b')
    print("Added 3rd identity_block!")
    ...
    print("Added 4th conv_block!")
    x = identity_block(x, 3, [512, 512, 2048], stage=5, block='b')
    print("Added 4th identity_block!")
