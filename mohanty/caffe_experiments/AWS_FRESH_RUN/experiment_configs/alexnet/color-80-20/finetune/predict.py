...
# This function prints the prediction output to the console
...
PRETRAINED = '/scratch/user/skumar55/mohanty/AWS_FRESH_RUN/snapshots_final/alexnet_color-80-20_finetune/snapshots__iter_13127.caffemodel'
PLANT_COLOR = 'color' # Options: color/grayscale/segmented
FOLDER = 2
IMG_IDX = 5
