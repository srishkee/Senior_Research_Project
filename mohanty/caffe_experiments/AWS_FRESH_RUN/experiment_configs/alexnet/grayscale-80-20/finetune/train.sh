...
#SBATCH --job-name=Alex_grayscale_80_20       #Set the job name to "JobExample2"
...
caffe train -solver solver.prototxt -weights /scratch/user/skumar55/mohanty/caffe_experiments/AWS_FRESH_RUN/models/bvlc_alexnet.caffemodel -gpu 0 &> caffe.log
#sbatch test.sh
