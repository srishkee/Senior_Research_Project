...
PRETRAINED = '/scratch/user/skumar55/mohanty/AWS_FRESH_RUN/snapshots_final/alexnet_grayscale-80-20_finetune/snapshots__iter_13085.caffemodel'
PLANT_COLOR = 'grayscale' # Options: color/grayscale/segmented
FOLDER = 0
IMG_IDX = 22
