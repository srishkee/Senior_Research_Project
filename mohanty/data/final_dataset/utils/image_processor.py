...
#        return scipy.misc.imresize(image, (height, width), interp=interp)
        return np.array(PIL.Image.fromarray(image).resize(size=(height, width), resample=PIL.Image.BILINEAR))
...
#        image = scipy.misc.imresize(image, (resize_height, resize_width), interp=interp)
        image = np.array(PIL.Image.fromarray(image).resize(size=(resize_height, resize_width), resample=PIL.Image.BILINEAR))
